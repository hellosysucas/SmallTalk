...
def test(request):
    ...
    insert_new_comment("13", "test", "lc", True)
    ...
    return  HttpResponse( getTheStoreMessage("test2", 0));
    '''
    ...
    '''test become_my_friend
    become_my_friend("mt", "lc")
    become_my_friend("mt", "zp")
    
    return HttpResponse( getFriendsList("mt", 0) )
    ''' 
